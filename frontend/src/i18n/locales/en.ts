...
export const en: Translations = {
  ...
  reward: {
    title: 'Reward Status',
    description: 'Complete todos and earn rewards!',
    completedCount: 'Completed Todos',
    completedUnit: '',
    nextGoal: 'Until next goal',
    remaining: '{count} remaining',
    allAchieved: 'All rewards achieved!',
    small: 'Small Reward',
    medium: 'Medium Reward',
    large: 'Large Reward',
    milestone10: '10 completed',
    milestone30: '30 completed',
    milestone100: '100 completed',
    achieved: 'Achieved!',
    notSet: 'No reward set',
    setReward: 'Set Reward',
    editReward: 'Edit Reward',
    rewardTitle: 'Reward Name',
    rewardDescription: 'Reward Details (optional)',
    rewardTitlePlaceholder: 'e.g. Eat pizza',
    rewardDescriptionPlaceholder: 'e.g. Order delicious pizza!',
  },
  pagination: {
